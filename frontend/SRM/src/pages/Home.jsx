...
const Home = ({error, user}) => {
  ...
  <section className="bg-[#fbf6ec] w-full rounded-b-3xl py-16 px-4 mt-0">
    ...
    <section className="bg-[#fbf6ec] w-full rounded-b-3xl py-16 px-4 mt-0">
      <div className="max-w-6xl mx-auto text-center">
        <h1 className="font-serif text-3xl md:text-5xl text-[#000000] tracking-widest uppercase">
          Our Valued Partners
        </h1>
        <p className="mt-8 text-sm md:text-base leading-relaxed text-gray-800 max-w-4xl mx-auto px-4">
    ...
    <section className="bg-black py-16 md:py-24">
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="flex flex-col items-center">
            <div className="w-md h-150 overflow-hidden bg-gray-900 border-b border-yellow-500">
              <img 
                src="../../assets/Drinks & Cocktail-20251112T095416Z-1-001/Drinks & Cocktail/alcohol_03.jpg"
                alt="Drinks & Cocktails"
                className="w-md h-full object-cover transition duration-300 hover:scale-105"
              />
            </div>
            {/* Label */}
            <h3 className="text-white text-xl uppercase tracking-widest mt-4">
    ...
    <section className="bg-[#F5F0E8] py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="w-full h-full">
            <img 
              ...
              style={{ height: '700px' }} // Giving a fixed height to match the design
            />
          </div>

          {/* Content */}
          <div className="flex flex-col justify-center">
            <h2 className="text-4xl sm:text-5xl font-serif text-yellow-700 mb-6">
      ...
      <section className="bg-black py-20 border-b border-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
            ...
            {/* Stat 1 */}
            <div>
              <div className="text-5xl md:text-6xl font-serif text-yellow-500 mb-2">
                10+
              </div>
      ...
      <section className="relative h-[700px] w-full overflow-hidden flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-7xl md:text-8xl font-serif text-white mb-8 tracking-tight">
            Why Us
          </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            <h2 className="text-6xl md:text-7xl font-serif text-yellow-500 mb-4">
              Blog
            </h2>
            <a href="#" className="text-white text-lg tracking-wider underline hover:text-yellow-500 transition-colors">
              Read More
            </a>
          </div>
          {/* Blog Posts Grid */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group">
              <a href="#">
                ...
                <h3 className="text-white text-xl leading-snug">
